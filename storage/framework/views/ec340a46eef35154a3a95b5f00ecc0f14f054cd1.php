    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile rounded-circle" src="<?php echo e(asset('/images/user.jpg')); ?>">
            </a>
...
<?php /**PATH D:\WebSite\kimiaAcademy-next\kimiaAcademy\resources\views/admin/layouts/partials/topbar.blade.php ENDPATH**/ ?>
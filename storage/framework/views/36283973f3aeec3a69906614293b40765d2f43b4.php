<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion pr-0" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseProducts" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('admin.courses.index')); ?>">دوره ها</a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.educationalvideos.index')); ?>">
            <i class="fas fa-store"></i>
...
<?php /**PATH D:\WebSite\kimiaAcademy-next\kimiaAcademy\resources\views/admin/layouts/partials/sidebar.blade.php ENDPATH**/ ?>